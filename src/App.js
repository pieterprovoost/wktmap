    ...
    <div id="app">
      ...
      <footer className="footer mt-auto pt-5 pb-4 bg-light">
        <Container>
          ...
          <p className="text-muted">Created by <Twitter className="mb-1"/> <a rel="noreferrer" className="text-muted" href="https://twitter.com/PieterPrvst" target="_blank">PieterPrvst</a>. Support wktmap.com and <a href="https://buymeacoffee.com/pieterprovoost" rel="noreferrer" className="text-muted" target="_blank">buy me a coffee</a>.</p>
        </Container>
      </footer>
